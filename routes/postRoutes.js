...
// Rutas protegidas
router.post("/", authMiddleware, upload.single("media"), createPost); // Crear una nueva publicación
router.put("/:id", authMiddleware, upload.single("media"), updatePost); // Actualizar una publicación
